...
def get_pois():
    special_pois = [
        ...
        "id": 32,
        "name": "Кяфар",
        "description": "Река Кяфар, вдоль которой проходит часть маршрута.",
        "pass_category": None,
        "category": "река",
        "coords": [
        43.6996615,
        ...
        {
        "id": 107,
        "name": "Софийское седло",
        "description": "Перевал Софийское седло (2571 м), некатегорийный, расположен в Софийской долине рядом с Софийскими водопадами.",
        "pass_category": "н/к",
        "category": "перевал",
        "coords": [
        43.4341572,
